...
insert into products(id, name, price, quantity, image_url) values (0, 'Jacket', 500, 150, 'storage/media-content/girl.jpg');
insert into products(id, name, price, quantity, image_url) values (1, 'Dress', 1000, 10, 'storage/media-content/nocontent.jpg');

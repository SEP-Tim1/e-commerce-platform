...
insert into products(id, name, price, quantity, image_url) values (0, 'Mouse', 500, 150, 'storage/media-content/mis.jpg');
insert into products(id, name, price, quantity, image_url) values (1, 'Monitor', 1000, 10, 'storage/media-content/monitor.jpg');
